...
class Settings(Base):
    ...
    created_at = Column(DateTime, default=lambda: datetime.datetime.now(timezone.utc), comment="创建时间")
    updated_at = Column(DateTime, default=lambda: datetime.datetime.now(timezone.utc), onupdate=lambda: datetime.datetime.now(timezone.utc), comment="更新时间")
    def __repr__(self):
...
class ErrorLog(Base):
    ...
    request_time = Column(DateTime, default=lambda: datetime.datetime.now(timezone.utc), comment="请求时间")
